...
public class AzkabanTest {
    ...
    private static String API = "xxxxx";
    //private static String API = "http://localhost:8443";
    ...
    public void fetchFlowAProTest () throws KeyManagementException, NoSuchAlgorithmException {
        ...
        map.put("id", "3f808949-2d22-4dd8-96d6-a314aa6d55ba");
        map.put("project", "JobMock");
